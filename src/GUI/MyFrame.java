...
public class MyFrame {
	public MyFrame() {
		...
		JButton vs1 = new JButton(new ImageIcon("C:\\projectman\\Button1.png"));
		JButton vs2 = new JButton(new ImageIcon("C:\\projectman\\Button2.png"));
		JButton exit = new JButton(new ImageIcon("C:\\projectman\\Exit.png"));
		JButton logo = new JButton(new ImageIcon("C:\\projectman\\Clogo.png"));

		vs1.setBorderPainted(false);
		vs2.setBorderPainted(false);
		exit.setBorderPainted(false);
		logo.setBorderPainted(false);
		vs1.setContentAreaFilled(false);
		vs2.setContentAreaFilled(false);
		exit.setContentAreaFilled(false);
		logo.setContentAreaFilled(false);
		vs1.setFocusPainted(false);
		vs2.setFocusPainted(false);
