...
public class Message extends MyFrame {
   public static void EndMessage() {
      ImageIcon draftIcon = new ImageIcon("C:\\javaProject\\Checkmate.png");
      ...
      JButton mainbtn = new JButton(new ImageIcon("C:\\javaProject\\main.png"));
      JButton exitbtn = new JButton(new ImageIcon("C:\\javaProject\\finish.png"));
